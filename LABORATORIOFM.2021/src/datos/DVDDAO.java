...
public class DVDDAO {
       ...
       private static final String SQL_INSERT = "INSERT INTO registroproductodvid(ID,Nombre,Clasificacion,valor) VALUES(?, ?,?, ?)";
    private static final String SQL_SELECT = "SELECT ID,Nombre,Clasificacion,valor FROM registroproductodvid";
    private static final String SQL_QUERY = "SELECT ID,Nombre,Clasificacion,valor FROM registroproductodvid WHERE ID = ?";
 private static final String SQL_UPDATE = "UPDATE  registroproductodvid SET  ID=? ,Nombre=? , Clasificacion=? , valor =? WHERE ID";
    private static final String SQL_DELETE = "DELETE FROM registroproductodvid  WHERE ID = ? ";
